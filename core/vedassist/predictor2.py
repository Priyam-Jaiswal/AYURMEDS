...
downloads_dir = os.path.join("", "C:/Users/piyush jaiswal/OneDrive/Desktop/Ayurmeds (2)/Ayurmeds/Vedassist-master/Vedassist-master/core/vedassist/ml_model/model2.pkl")
